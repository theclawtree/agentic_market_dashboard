    ...
    return pd.DataFrame([
        {
            ...
            "description": "Major institutions increase Bitcoin holdings as price approaches all-time highs.",
            "source": "CoinDesk",
        ...
        },
        {
            ...
            "description": "Multiple Fed governors oppose rate cuts, saying inflation remains too high.",
            "source": "Reuters",
