...
def analyze_with_ollama(
    headline: str, description: str, market_question: str, ollama_url: str, model: str
) -> dict:
...
def _keyword_fallback(headline: str, description: str, market_question: str) -> dict:
    ...
    stop = {"will", "the", "a", "be", "by", "in", "of", "?"}
    q_words = set(market_question.lower().split()) - stop
    ...
    return {
        ...
        "relevance": round(min(overlap, 1.0), 2),
    }
